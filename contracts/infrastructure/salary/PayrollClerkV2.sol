...
import "./PayrollClerkStorageV2.sol";

/// @title Disperse salary to workers
/// @author belbix
contract PayrollClerkV2 is PayrollClerkStorageV2 {
  ...
  function isPayer(address _address) public view returns (bool) {
    return payers[_address];
  }

  function addPayer(address _address) public onlyControllerOrGovernance {
    payers[_address] = true;
  }
